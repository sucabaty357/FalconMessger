...
class SelectedMediaCollectionCell: UICollectionViewCell {
  ...
  var remove: UIButton = {
    ...
    remove.setImage(#imageLiteral(resourceName: "remove"), for: .normal)
  ...
  let videoIndicatorView: UIImageView = {
    let videoIndicatorView = UIImageView(image: #imageLiteral(resourceName: "ImageCell-Video"))
  ...
  @objc func longTap(_ gestureReconizer: UILongPressGestureRecognizer) {
    ...
    if gestureReconizer.state == .began {
      ...
      cell.playerView.play.setImage(#imageLiteral(resourceName: "pause"), for: .normal)
    }
    ...
    if gestureReconizer.state == .cancelled || gestureReconizer.state == .failed || gestureReconizer.state == .ended {
      ...
      cell.playerView.play.setImage(#imageLiteral(resourceName: "playWhite"), for: .normal)
    }
  }
